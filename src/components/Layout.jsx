...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen bg-transparent">
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    isActive ? "bg-slate-900 text-white" : "text-slate-400 dark:text-slate-500 hover:text-slate-900 dark:hover:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-700"
                  )}
                >
            ...
            <Link
              ...
              className={cn(
                ...
                location.pathname === "/Settings"
                  ...
                  : "text-slate-400 dark:text-slate-500 hover:text-slate-900 dark:hover:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-700"
              )}
            >
      ...
      <nav className="sm:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl border-t border-slate-100 dark:border-slate-800 px-1 pt-2 pb-5">
