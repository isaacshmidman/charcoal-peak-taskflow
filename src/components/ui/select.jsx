...
const SelectTrigger = React.forwardRef(function SelectTrigger({ className, children, ...props }, ref) {
  return (
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex h-9 w-full items-center justify-between whitespace-nowrap rounded-md border border-input bg-white dark:bg-[#0c0c0c] px-3 py-2 text-sm text-foreground shadow-sm ring-offset-background data-[placeholder]:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
        className
      )}
      {...props}>
      {children}
...
/** @type {import("react").ForwardRefExoticComponent<SelectScrollUpButtonProps & import("react").RefAttributes<SelectScrollUpButtonElement>>} */
...
/** @type {import("react").ForwardRefExoticComponent<SelectScrollDownButtonProps & import("react").RefAttributes<SelectScrollDownButtonElement>>} */
